...
def system_collision_bullet_player(world:esper.World, player_explosion_file: dict, config_level:dict):
    ...
    componentsBP = world.get_components(CSurface, CTagBullet)
    for enemy_bullet_entity, (enemy_bullet_s, enemy_bullet_t, _) in componentsB:
        ...
        for player_entity, (player_s, player_t, player_tag) in componentsP:
            ...
            if player_rect.colliderect(bullet_rect):
                ...
                for bullet_player_entity, (_, bullet_player_tag) in componentsBP:
